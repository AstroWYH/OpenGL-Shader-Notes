...
![image-20220505194304373](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505194304373.png)
...
![image-20220505194716990](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505194716990.png)
...
![image-20220505195159457](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505195159457.png)
...
![image-20220505195333779](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505195333779.png)

现在我们可以用它来对妞妞的鼻子进行模型变换了：

![image-20220505195406167](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505195406167.png)
...
![image-20220505195829352](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505195829352.png)
...
![image-20220505200206819](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505200206819.png)

但是，由于观察空间使用的是右手坐标系，因此需要对z分量进行取反操作。我们可以通过乘以另一个特殊的矩阵来得到最终的观察变换矩阵：

![image-20220505200244009](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505200244009.png)

现在我们可以用它来对妞妞的鼻子进行顶点变换了：

![image-20220505200310095](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505200310095.png)
...
![image-20220505200842767](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505200842767.png)
...
![image-20220505201001825](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505201001825.png)
...
![image-20220505201828445](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505201828445.png)
...
![image-20220505201933689](C:/Users/m-astrowang/AppData/Roaming/Typora/typora-user-images/image-20220505201933689.png)
...
![image-20220505202026666](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505202026666.png)

现在，我们可以根据已知的**Near、Far、FOV和Aspect**的值来确定**透视投影**的**投影矩阵**。如下：

![image-20220505202052675](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505202052675.png)
...
![image-20220505202146102](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505202146102.png)
...
![image-20220505202252912](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505202252912.png)

任何不满足上述条件的图元都需要被剔除或者裁剪。图4.39显示了经过上述投影矩阵后，视锥体的变化。

![image-20220505202326917](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505202326917.png)
...
![image-20220505202833310](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505202833310.png)
...
![image-20220505202949365](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505202949365.png)

现在我们还缺乏横向的信息。同样，我们可以通过摄像机的横纵比得到。假设，当前摄像机的横纵比为Aspect，那么：

![image-20220505203012284](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505203012284.png)

现在，我们可以根据已知的**Near、Far、Size和Aspect**的值来确定**正交投影的裁剪矩阵**。如下：

![image-20220505203108537](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505203108537.png)

上面公式的推导部分可以参见本章的扩展阅读部分。同样，这里的投影矩阵是建立在Unity对坐标系的假定上面的。一个顶点和上述投影矩阵相乘后的结果如下：

![image-20220505203151180](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505203151180.png)
...
![image-20220505203329496](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505203329496.png)
...
![image-20220505203448338](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505203448338.png)

据此，我们可以知道<u>透视投影的参数：FOV为60°, Near为5, Far为40, Aspect为4/3 = 1.333。</u>那么，**对应的投影矩阵**就是：

![image-20220505203510429](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505203510429.png)

然后，我们用这个投影矩阵来把妞妞的鼻子从<u>观察空间转换到裁剪空间</u>中。如下：

![image-20220505203602887](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505203602887.png)

这样，我们就求出了妞妞的鼻子在**裁剪空间**中的位置——**(11.691, 15.311,23.692, 27.31)**。接下来，<u>Unity会判断妞妞的鼻子是否需要裁剪</u>。通过比较得到，妞妞的鼻子满足下面的不等式：

![image-20220505203642961](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505203642961.png)
...
![image-20220505204320321](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505204320321.png)

而对于正交投影来说，它的裁剪空间实际已经是一个立方体了，而且由于经过正交投影矩阵变换后的顶点的w分量是1，因此齐次除法并不会对顶点的x、y、z坐标产生影响，如图4.44所示。

![image-20220505204348711](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505204348711.png)
...
![image-20220505204527901](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505204527901.png)
...
![image-20220505204820862](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505204820862.png)
...
![image-20220505205211250](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505205211250.png)
...
![image-20220505205519736](https://gitee.com/hanbabang/hanbabang-pics/raw/master/image-20220505205519736.png)
